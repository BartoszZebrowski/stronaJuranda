...
<body>
        ...
        <div class="slider">
            ...
            <div class="slides">
                ...
                <div class="slide First">
                    <img src="img/photoToSlide/photo1.jpg" alt="">
                </div>
                <div class="slide">
                    <img src="img/photoToSlide/photo2.jpg" alt="">
                </div>
                <div class="slide">
                    <img src="img/photoToSlide/photo3.jpg" alt="">
                </div>
                <div class="slide">
                    <img src="img/photoToSlide/photo4.jpg" alt="">
                </div>
    ...
    <h2 class="ofertyTytul" id="scrollOferta">Angebot</h2>
    <section class="oferty">
        <div class="oferta">
            <div class="zdjecieOferty"></div>
            <div class="tytulOferty">
                <h2>Heblowanie</h2>
            </div>
            <div class="opisOferty"> Lorem ipsum dolor sit, amet consectetur adipisicing elit. Modi distinctio
                voluptatem nostrum quia a, ab similique incidunt sint suscipit, molestias aliquid ullam animi repellat
                tempora aut earum dolore sapiente laboriosam.</div>
        </div>
    ...
    <section class="oNas" id="scrollOnas">
        ...
        <div class="fotoONas"></div>
    </section>

    <h2 class="galeriaTytul" id="scrollGaleria"> Galerie</h2>
    <section class="galeria">
        <div class="fotoGaleria">
            <div class="foto"><img src="img/untitled-1.jpg"></div>
            <div class="foto"><img src="img/untitled-2.jpg"></div>
            <div class="foto"><img src="img/untitled-3.jpg"></div>
            <div class="foto"><img src="img/untitled-4.jpg"></div>
            <div class="foto"><img src="img/untitled-5.jpg"></div>
            <div class="foto"><img src="img/untitled-6.jpg"></div>
            <div class="foto"><img src="img/untitled-7.jpg"></div>
            <div class="foto"><img src="img/untitled-8.jpg"></div>
            <div class="foto"><img src="img/untitled-9.jpg"></div>
            <div class="foto"><img src="img/untitled-10.jpg"></div>
            <div class="foto"><img src="img/untitled-11.jpg"></div>
            <div class="foto"><img src="img/untitled-12.jpg"></div>
            <div class="foto"><img src="img/untitled-13.jpg"></div>
            <div class="foto"><img src="img/untitled-14.jpg"></div>
            <div class="foto"><img src="img/untitled-15.jpg"></div>
            <div class="foto"><img src="img/untitled-16.jpg"></div>

            <!-- Tu musi być 12 lub 24 lub (liczba podzielna jednocześnie przez 3 i 4) zdjeć -->
    ...
    <footer>
        <div class="footerBox" id="scrollKontakt">
            <div class="info">
                <a class="stopka">
                    Adresse: Behaimring 3, </br></br>23564 Lübeck </br></br>
                    Telefon: 017660737401 </br><br>
                    E-mail: floor.work@mail.de
                </a>
            </div>
        </div>
        <div class="linia">
    ...
    <script src="js/apperElements.js"></script>
